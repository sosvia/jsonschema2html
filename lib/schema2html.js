...
function Schema2Html(schema, data, options) {
    ...
    this.lookupTable = {
        ...
        enum: this.renderLoopEnum.bind(this)
    };
}
...
Schema2Html.prototype.buildForm = function(callback) {
    ...
    schemaDependencies.resolveDependencies(this.schema, function(err, dependencies) {
		...
		var tmp_cb = _that.addFormOpen(_that.schema.id, _that.options.endpoint, _that.options.method)
        _that.addRenderTask(tmp_cb);
		...
		async.series(_that.funcs, function(err, results) {
            callback(err, _that.html.join(""), _that.htmlTemplate.join("").replace(expId,'-' + idxReplace).replace(expBracket, '[' + idxReplace + ']').split('id="').join('id="tmpl-').split("id='").join("id='tmpl-"));
        });
    });
...
Schema2Html.prototype.buildFormPromise = function() {

	var _that = this;

	this.addRenderTask(this.addFormOpen(this.schema.id, this.options.endpoint, this.options.method));
	this.renderLoop(this.schema, 0, this.options.dataPrefix, false);
	this.addRenderTask(this.addFormClose());
...
Schema2Html.prototype.registerCustomType = function(){

}

Schema2Html.prototype.lookupCustomType = function(type) {
...
Schema2Html.prototype.lookupTableFunc = function(type, schema) {
...
Schema2Html.prototype.renderLoopArrayEnum = function(id, name, depth, index, schema) {
	this.renderLoop(schema, depth + 1, name + '[' + index + ']');
...
Schema2Html.prototype.renderLoopArray = function(id, name, depth, schema) {
    ...
    itemsToRender = this.renderMode === 3 ? 0 : itemsToRender;
    itemsToRender = schema.items.enum ? 1 : itemsToRender;
	...
	if (schema.items.enum) {
        this.addRenderTask(this.addGroupTag('endGroup', id + '-group-many', name, depth, schema));
	} else {
...
Schema2Html.prototype.renderLoopBoolean = function(id, name, depth, schema) {
    ...
    this.addRenderTask(this.addBoolean(id, name, val, label, null, options));
};

/*
 * @memberOf Schema2Html
 * @description adds an individual render task for the enum schema property
 *
 * @param {string} id html id string
 * @param {string} name html name string
 * @param {integer} depth how deep the item is nested
 * @param {object} schema
 */
Schema2Html.prototype.renderLoopEnum = function(id, name, depth, schema) {
    var label = schema.title || name,
        options = schema.options || {},
        val = util.retrieveValue(this.data, name, false),
        datasrc = schema.enum.map(function(s) {
	...
	if (schema.$parent) {
		this.addRenderTask(this.addSelectCheckbox(id, name, val, label, null, datasrc, options));
	} else {
		this.addRenderTask(this.addSelect(id, name, val, label, null, datasrc, options));
	}
};
...
Schema2Html.prototype.addGroupOpen = function(id, total, depth, options) {
    var _that = this,
        pos = this.pos;
...
Schema2Html.prototype.renderGroupOpen = function(id, total, depth, options, callback) {
    var params = {};
...
/**
 * @memberOf Schema2Html
 * @description return a function that renders boolean template based on input variables
 *
 * @param {string} id
 * @param {string} name
 * @param {*} val
...
Schema2Html.prototype.addBoolean = function(id, name, val, label, src, options, required) {
    var _that = this,
        pos = this.pos;
    ...
    return function(callback) {
        _that.renderBoolean(id, name, val, label, src, options, required, function(err, result) {
			if (err) {
				console.log(err);
				return;
			}
            _that.appendHtml(result, pos);
            //callback(err, result);
            _that.renderBoolean(id, name, null, label, src, options, required, function(err, resultTwo) {
                _that.appendDummyHtml(resultTwo, pos);
                callback(err, result);
            });
        });
...
/**
 * @memberOf Schema2Html
 * @description Render boolean template
 *
 * @param {string} id
 * @param {string} name
 * @param {*} val
...
Schema2Html.prototype.renderBoolean = function(id, name, val, label, src, options, required, callback) {
    var params = {},
        template = 'checkbox';
...
/**
 * @memberOf Schema2Html
 * @description return a function that renders select template based on input variables
 *
 * @param {string} id
 * @param {string} name
 * @param {*} val
...
Schema2Html.prototype.addSelect = function(id, name, val, label, src, datasrc, options, required) {
    var _that = this,
        pos = this.pos;
    ...
    return function(callback) {
        _that.renderSelect(id, name, val, label, src, datasrc, options, required, function(err, result) {
			if (err) {
				console.log(err);
				return;
			}
            _that.appendHtml(result, pos);
            //callback(err, result);
            _that.renderSelect(id, name, null, label, src, datasrc, options, required, function(err, resultTwo) {
                _that.appendDummyHtml(resultTwo, pos);
                callback(err, result);
            });
        });
...
/**
 * @memberOf Schema2Html
 * @description Render select template
 *
 * @param {string} id
 * @param {string} name
 * @param {*} val
...
Schema2Html.prototype.renderSelect = function(id, name, val, label, src, datasrc, options, required, callback) {
    var params = {},
        template = 'selectlist';
...
Schema2Html.prototype.addSelectCheckbox = function(id, name, val, label, src, datasrc, options, required) {
    var _that = this,
        pos = this.pos;
    ...
    return function(callback) {
        _that.renderSelectCheckbox(id, name, val, label, src, datasrc, options, required, function(err, result) {
			if (err) {
				console.log(err);
				return;
			}
            _that.appendHtml(result, pos);
            //callback(err, result);
            _that.renderSelectCheckbox(id, name, null, label, src, datasrc, options, required, function(err, resultTwo) {
                _that.appendDummyHtml(resultTwo, pos);
                callback(err, result);
            });
        });
...
Schema2Html.prototype.renderSelectCheckbox = function(id, name, val, label, src, datasrc, options, required, callback) {
    var params = {},
        template = 'selectcheckbox';
