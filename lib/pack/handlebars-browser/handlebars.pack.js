...
module.exports = {
    ...
    templates: {
		...
		"tableOpen": "templates/tableOpen.hbs",
		"tableClose": "templates/tableClose.hbs",
		"tableRowOpen": "templates/tableRowOpen.hbs",
		"tableRowClose": "templates/tableRowClose.hbs",
		"tableItem": "templates/tableItem.hbs",
		"checkbox": "templates/checkbox.hbs",
		"selectcheckbox": "templates/select.checkbox.hbs",
		"tableHeader": "templates/tableHeader.hbs",
		"tableHeaderOpen": "templates/tableHeaderOpen.hbs",
		"tableHeaderClose": "templates/tableHeaderClose.hbs",
		"tableBodyOpen": "templates/tableBodyOpen.hbs",
		"tableBodyClose": "templates/tableBodyClose.hbs",
		"tableHeaderActions": "templates/tableHeaderActions.hbs",
		"tableActions": "templates/tableActions.hbs"
    },
    ...
    loadTemplate: function(key, callback) {
		...
		request('/lib/pack/handlebars-browser/' + path, function(err, response, data) {
            var html;
